# 6.1 Mercury L1 Python API
[toc]

## 6.1.1 Pre-use Preparation
...
## 6.1.2 Introduction to Using the Arm API
...
## 6.1.3 Chassis Basic Control Interfaces
...
#### 6.1 Get Chassis System Version
...
#### 6.2 Controlling Chassis Movement
